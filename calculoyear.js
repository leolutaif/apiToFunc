...
async function calcularyear({
    ...
    let AnoExHono1 = parseFloat(anosUnicosHonorarios[0]) || null;
    let AnoExHono2 = parseFloat(anosUnicosHonorarios[1]) || null;
    let AnoExHono3 = parseFloat(anosUnicosHonorarios[2]) || null;
    let AnoExHono4 = parseFloat(anosUnicosHonorarios[3]) || null;
    let AnoExHono5 = parseFloat(anosUnicosHonorarios[4]) || null;
    ...
    if (AnoExercicio1 === AnoExHono1) {
        RT1 = SumRendTribAlvara1 - SumRendTribHonorarios1
    }
    else{
        RT1 = SumRendTribAlvara1
    }
    if (AnoExercicio2 === AnoExHono2) {
        RT2 = SumRendTribAlvara2 - SumRendTribHonorarios2
    }
    else{
        RT2 = SumRendTribAlvara2
    }
    if (AnoExercicio3 === AnoExHono3) {
        RT3 = SumRendTribAlvara3 - SumRendTribHonorarios3
    }
    else{
        RT3 = SumRendTribAlvara3
    }
    if (AnoExercicio4 === AnoExHono4) {
        RT4 = SumRendTribAlvara4 - SumRendTribHonorarios4
    }
    else{
        RT4 = SumRendTribAlvara4
    }
    if (AnoExercicio5 === AnoExHono5) {
        RT5 = SumRendTribAlvara5 - SumRendTribHonorarios5
    }
    else{
        RT5 = SumRendTribAlvara5
    }
